...
app.get("/posts/:postId", (req, res) => {
  ...
  //   if (paramsText === postTitle) {
  //     res.render("post", { postHead: post.title, postContent: post.content });
  //   }
  // });

  Post.findById(requestPostId,function(error,foundPost){
      res.render("post", { postHead: foundPost.title, postContent: foundPost.content });
